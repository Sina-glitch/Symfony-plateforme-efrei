 ...
 */
final class Version20250105210332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature ADD CONSTRAINT FK_E33BD3B8E77B7C09 FOREIGN KEY (user_id) REFERENCES benevole (id)');
