 ...
 */
final class Version20250105205911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature ADD user_id INT NOT NULL, DROP benevole_id, CHANGE offre_id offre_id INT NOT NULL, CHANGE status statut VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature ADD benevole_id INT DEFAULT NULL, DROP user_id, CHANGE offre_id offre_id INT DEFAULT NULL, CHANGE statut status VARCHAR(20) NOT NULL');
        $this->addSql('ALTER TABLE candidature ADD CONSTRAINT FK_E33BD3B8E77B7C09 FOREIGN KEY (benevole_id) REFERENCES benevole (id)');
        $this->addSql('CREATE INDEX IDX_E33BD3B8E77B7C09 ON candidature (benevole_id)');
